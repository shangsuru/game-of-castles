...
public class EmperorAI extends AI {

  public EmperorAI(String name, Color color) {
    super(name, color);
  }
  ...
  private void pickCastles(Game game) throws InterruptedException {
    ...
    while(availableCastles.size() > 0 && getRemainingTroops() > 0) {
      ...
      Castle chosenCastle = availableCastles.get(0);
  ...
  private Castle attack(Game game) throws InterruptedException {
    ...
    do {
      ...
      if (attackingCastle.getTroopCount() >= 4 * weakestEnemy.getTroopCount()) {
